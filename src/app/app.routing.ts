            ...
            // Dashboards
            {
                ...
                children: [
                    ...
                    },
                    {
                        ...
                        loadChildren: () =>
                            import(
                                'app/modules/admin/dashboards/relax/relax.module'
                            ).then(m => m.RelaxModule),
                    },
                    {
                        path: 'crud',
                        loadChildren: () =>
                            import(
                                'app/modules/admin/dashboards/crud/crud.module'
                            ).then(m => m.CrudModule),
                    },
                    {
                        path: 'prop', loadChildren: () => import('app/modules/admin/dashboards/prop/prop.module')
                            .then(m => m.PropModule)
                    },
                    {
